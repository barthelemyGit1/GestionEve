...
<div class="card">
<div class="">
 <a class="btn btn-danger float-end" style="margin-right:5px; margin-top:3px" onclick="retourner()">Annuler</a>
 </div>
...
<br>
 ...
 <div class="card-header" style="height:45px;" ><h1 class="float-none " style="margin-left:300px;margin-top:-10px"><b>Versement</b></h1>
    ...
    <form  action ="{{route('Paiement.store')}}" method="POST" enctype="multipart/form-data" style="padding:5px">
        @csrf
        <div class="row">
            <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <input type="file" name="image" id="exampleFormControlFile1" class="form-control-file mt-2"  />
                @error('image')
                    <small class="text-danger">{{$message}}</small>
                @enderror
            </div>
